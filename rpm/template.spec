...
Name:           ros-jazzy-mrpt-tps-astar-planner
Version:        2.2.1
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS mrpt_tps_astar_planner package
...
Requires:       ros-jazzy-mrpt-path-planning
...
BuildRequires:  ros-jazzy-mrpt-path-planning
